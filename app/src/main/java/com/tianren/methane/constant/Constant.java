...
//    public static final String BASE_URL = "http://iot.tianren.com" ;
    public static final int INTENT_TYPE_YANYANG = 1;//厌氧列表
    public static final int INTENT_TYPE_QIGUI = 2;//气柜列表

    public static final String ENTRYYANYANG_URL = "/entry/entryAnaerobicTankData";
    public static final String ENTRYCAPACITY_URL = "/entry/entryCapacity";
    public static final String ENTRYCONSUMPTION_URL = "/entry/entryConsumptionData";
