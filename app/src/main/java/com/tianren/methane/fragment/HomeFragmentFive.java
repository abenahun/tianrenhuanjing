...
public class HomeFragmentFive extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_home_five, null);
//        initFlipper();
        initView();
//        initLineCharts();
        return view;
...
//        ll_jinliaoliang.setOnClickListener(this);
        ...
        airEarningsPer = (TextView) view.findViewById(R.id.airEarningsPer);
        butieEarningsPer = (TextView) view.findViewById(R.id.butieEarningsPer);
        youzhiEarningsPer = (TextView) view.findViewById(R.id.youzhiEarningsPer);
        zhaozhaEarningsPer = (TextView) view.findViewById(R.id.zhaozhaEarningsPer);
...
//                            allConsume.setText(MathUtils.scale2(((bean.getEleUseFactoryData() == null ? 0d : (bean.getEleUseFactoryData() * 0.65)) + 2)) + "元");
    ...
    private void initBarCharts() {
        ...
        xAxisValues.add("06-07");
        yAxisValues1.add((float) (41789));
        yAxisValues2.add((float) (11696));
        xAxisValues.add("06-08");
        yAxisValues1.add((float) (43658));
        yAxisValues2.add((float) (12698));
        xAxisValues.add("06-09");
        yAxisValues1.add((float) (46854));
        yAxisValues2.add((float) (14369));
        xAxisValues.add("06-10");
        yAxisValues1.add((float) (42687));
        yAxisValues2.add((float) (14458));
        xAxisValues.add("06-11");
        yAxisValues1.add((float) (43698));
        yAxisValues2.add((float) (13005));
        xAxisValues.add("06-12");
        yAxisValues1.add((float) (44949));
        yAxisValues2.add((float) (13968));
        xAxisValues.add("06-13");
        yAxisValues1.add((float) (46154));
        yAxisValues2.add((float) (13372));
