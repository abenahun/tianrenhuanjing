...
//        }
        bean.setEntryType(1);
        String value = gson.toJson(bean).toString();
        WebServiceManage.getService(EntryService.class).entryCapacity(value).setCallback(new SCallBack<BaseResponse<Boolean>>() {
            @Override
