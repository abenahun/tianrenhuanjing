...
import com.tianren.methane.common.MyValueFormatter;
...
public class MPChartHelper {
    ...
    public static void setBarChart(BarChart barChart, List<String> xAxisValue,
                                   List<Float> yAxisValue, String title, float xAxisTextSize, Integer barColor) {
    ...
    private static void setBarChartData(BarChart barChart, List<Float> yAxisValue, String title, Integer barColor) {
        ...
        if (barChart.getData() != null && barChart.getData().getDataSetCount() > 0) {
            ...
            if (barColor == null) {
                set1.setColor(ContextCompat.getColor(barChart.getContext(), R.color.barchart));//设置set1的柱的颜色
            } else {
    ...
    private static void setThreeBarChartData(BarChart barChart, List<Integer> xAxisValue, List<Float> yAxisValue1, List<Float> yAxisValue2, List<Float> yAxisValue3, String bartilte1, String bartitle2, String bartitle3) {
        ...
        if (barChart.getData() != null && barChart.getData().getDataSetCount() > 0) {
            ...
            first_set.setColor(ContextCompat.getColor(barChart.getContext(), R.color.maincolor));
            second_set.setColor(ContextCompat.getColor(barChart.getContext(), R.color.orange));
            third_set.setColor(ContextCompat.getColor(barChart.getContext(), R.color.pink));
